...
// Use: https://github.com/FrameworkComputer/qmk_firmware
// Commit: e06fde429d5a52585ca47a18f9a43b7697f24a73
// Path: keyboards/frammework/ansi/keymaps/piston/keymap.c
//
// Figure out how to setup QMK again and compile:
// - TODO the next time I touch my keymaps
// - according to paston:
//   curl -fsSL https://install.qmk.fm | SKIP_UV=1 TARGET_PYTHON_VERSION=3.10 sh
//
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, MO(_FN), KC_LGUI, KC_LCTL,          KC_SPC,                    KC_RALT, KC_RCTL, KC_LEFT,   KC_UP, KC_DOWN, KC_RGHT
    ),
     /*
     * Function layer
     *         ┌─────┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬────┐
    ...
    [_FN] = LAYOUT(
        ...
        KC_LALT, _______, _______, KC_LALT,          BL_STEP,                   _______, _______,  KC_HOME, KC_PGUP, KC_PGDN, KC_END
    ),
    // Function lock layer
    ...
    [_FN_LOCK] = LAYOUT(
        ...
        KC_LALT, MO(_FM), _______, KC_LALT,          _______,                   _______, _______,  _______, _______, _______, _______
    ),
